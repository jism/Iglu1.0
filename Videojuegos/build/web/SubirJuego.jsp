        ...
        <header>
            ...
            <%if(session.getAttribute("v") != null){
                if(session.getAttribute("v").equals("1")){
                    String idvj=(String) request.getAttribute("idvj");
                    response.sendRedirect("MuestraVideojuego?i="+idvj);
                }
            }                  
            %>
            <div class="row-bot">
                <div class="row-bot-bg">
                    <div class="main">
					  ...
					  <pre>      Nombre:                     <input type="text" pattern="[0-9a-zA-Z+ ]{2,60}$" name="nombre" required/></pre>
